...
void BalanceRocky()
{
  ...
  float v_d = Kp * angle_rad + Ki * angle_rad_accum;

  speed_err_left  = v_d - measured_speedL;
  speed_err_right = v_d - measured_speedR;

  speed_err_left_acc  += speed_err_left * 0.01;
  speed_err_right_acc += speed_err_right * 0.01;

  v_c_R = v_d + Jp * speed_err_right + Ji * speed_err_right_acc + Ci * dist_accum;
  v_c_L = v_d + Jp * speed_err_left  + Ji * speed_err_left_acc  + Ci * dist_accum;
