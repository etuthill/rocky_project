...
void BalanceRocky() {
  ...
  float Kp = 633.3f;      // angle proportional gain
  float Ki = 2841.7f;     // angle integral gain
  float Ji = -108.8f;     // speed integral gain
  float Jp = -148.1f;     // speed proportional gain
  float Ci = -43.9f;      // distance integral gain
